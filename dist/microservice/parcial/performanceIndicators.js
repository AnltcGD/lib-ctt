...
const formatPerformanceIndicatorsWorkFronts = (workFrontJourneyMap, workFrontJourneyTractorMap, workFrontEfficiencyMap, workFrontShiftInefficiencyMap, workFrontProductionMap, workFrontWeightMap, tonPerHourGoalByTractor, workFrontTruckLackMap) => {
 ...
 */
const createPerformanceIndicators = async (workFrontJourneyMap, workFrontJourneyTractorMap, workFrontEfficiencyMap, workFrontShiftInefficiencyMap, workFrontProductionMap, workFrontWeightMap, tonPerHourGoalByTractor, workFrontTruckLackMap) => {
    try {
        const formattedWorkFronts = formatPerformanceIndicatorsWorkFronts(workFrontJourneyMap, workFrontJourneyTractorMap, workFrontEfficiencyMap, workFrontShiftInefficiencyMap, workFrontProductionMap, workFrontWeightMap, tonPerHourGoalByTractor, workFrontTruckLackMap);
