 ...
 */
declare const createPerformanceIndicators: (workFrontJourneyMap: Record<number, JourneyResponse>, workFrontJourneyTractorMap: Record<number, JourneyResponse>, workFrontEfficiencyMap: Record<number, EfficiencyResponse>, workFrontShiftInefficiencyMap: Record<number, string>, workFrontProductionMap: Record<number, GetProductionReturn>, workFrontWeightMap: Record<number, WorkFrontWeightReturn>, tonPerHourGoalByTractor: number, workFrontTruckLackMap: Record<number, number>) => Promise<CttPerformanceIndicators>;
